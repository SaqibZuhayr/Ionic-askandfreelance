...
var LoginPage = /** @class */ (function () {
    function LoginPage(formBuilder, user, route) {
    ...
    LoginPage.prototype.logForm = function () {
        var _this = this;
        this.user.login(this.loginForm).subscribe(function (data) {
            console.log(data);
            if (data[0]['_id']) {
                localStorage.setItem('userid', data[0]['_id']);
                localStorage.setItem('username', data[0]['username']);
                _this.route.navigate(['./sidemenu-question/question']);
    ...
    LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], LoginPage);
    return LoginPage;
}());
