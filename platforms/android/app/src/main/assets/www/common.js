...
var QuestionService = /** @class */ (function () {
    ...
    QuestionService.prototype.getQuestions = function (tag, id, search) {
        var _this = this;
        this.http.post('http://localhost:3000/questions', { tag: tag, id: id, search: search }).subscribe(function (data) {
            _this.questions.next(data);
            console.log(_this.questions);
        });
    };
    QuestionService.prototype.getMyQuestions = function (id) {
        var _this = this;
        this.http.post('http://localhost:3000/myQuestions', { id: id }).subscribe(function (data) {
            _this.questions.next(data);
            console.log(_this.questions);
        });
    };
